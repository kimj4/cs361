 ...
 *key = BitSet with 6 bits, representing the cooperate/defect decisions for the
 *last 3 rounds (2 bits per round, 1 for each player's decision in that round)
 *value = Integer index to find the corresponding decision in the individual's genome
